...
namespace Iso8601Duration.UnitTests
{
    ...
    public class PeriodBuilderTests
    {
        ...
        [MethodNamingTheory]
        [InlineData("PT61S", "PT1M1S")]
        [InlineData("PT61M", "PT1H1M")]
        [InlineData("PT25H", "P1DT1H")]
        [InlineData("PT58M61S", "PT59M1S")]
        [InlineData("PT59M61S", "PT1H1S")]
        [InlineData("PT23H59M61S", "P1DT1S")]
        [InlineData("P31D", "P1M1D")]
        [InlineData("P13M", "P1Y1M")]
        [InlineData("P11M31D", "P1Y1D")]
        [InlineData("P1Y", "P1Y")]
        [InlineData("P1Y31D", "P1Y1M1D")]
        [InlineData("P1Y11M31D", "P2Y1D")]
        [InlineData("P1Y11M30DT23H59M60S", "P2Y1D")]
        public void NormalizeDuration_FromPattern_ShouldBeExpectedPattern(string inputPattern, string expectedResult)
        {
            var returnedResult = this._periodBuilder.NormalizeDuration(inputPattern);
        ...
        public void ToString_FromDurationStruct_ShouldBeExpectedPattern()
        {
            ...
            foreach (var item in values)
            {
                ...
                Assert.Equal(item.Item2, returnedResult);
            }
        }
